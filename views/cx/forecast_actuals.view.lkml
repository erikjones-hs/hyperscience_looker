view: forecast_actuals {
  ...
  dimension: fed_sled {
    ...
    'Principal Life Insurance','Momentum','Mercury','State of CO','1-800-Contacts','Great American','Ascensus','Mutual of Omaha','CDCR','Voya','Natera','Ascensus') THEN 'Top 20 by FY 21 forecast'
