view: hr_attrition {
  ...
  measure: churned_employees_temp {
    ...
    sql: CASE WHEN ${date_month_month} = '2022-04' then -1*(${churned_employees_true} + 2)
              ...
              WHEN ${date_month_month} = '2022-12' then -1*(${churned_employees_true} + 337)
              WHEN ${date_month_month} = '2023-01' then -1*(${churned_employees_true} + 337)
  ...
  measure: active_employees_temp {
    ...
    sql: CASE WHEN ${date_month_month} = '2022-04' then (${active_employees_true})
              ...
              WHEN ${date_month_month} = '2023-01' then (${active_employees_true} + 237)
