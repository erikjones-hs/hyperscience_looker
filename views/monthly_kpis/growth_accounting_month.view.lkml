view: growth_accounting_month {
  sql_table_name: (select * from dev.erikjones.monthly_growth_accounting);;
  drill_fields: [detail*]
  ...
  measure: customer_debook {
    type:  sum
    sql:  ${debook_customer} ;;
    label: "De-Book Customers"
  }
