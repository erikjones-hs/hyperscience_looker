view: new_closed_won_opps {
  sql_table_name: (select * from "PROD"."DATA_QC"."DATA_QC_NEW_CLOSED_WON_OPPS");;
    ...
    dimension: closed_won_qtr_end_dte {
      type: date
      sql: ${TABLE}."CLOSED_WON_QTR_END_DTE" ;;
    }
    ...
    dimension: close_qtr_end_dte {
      type: date
      sql: ${TABLE}."CLOSE_QTR_END_DTE" ;;
    }
    ...
    dimension: start_qtr_end_dte {
      type: date
      sql: ${TABLE}."START_QTR_END_DTE" ;;
    }
